...
```shell
(E:\code\py\car-number-detection\env) PS E:\code\py\car-number-detection> conda list
# packages in environment at E:\code\py\car-number-detection\env:
#
...
ultralytics               8.3.140                  pypi_0    pypi
